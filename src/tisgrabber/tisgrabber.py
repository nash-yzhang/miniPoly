...
import os
import sys
# sys.path.insert(1, os.path.join(os.getcwd(), 'dlls'))
...
class TIS_GrabberDLL(object):
    if sys.maxsize > 2**32 :
        __tisgrabber = C.windll.LoadLibrary(os.path.join(FILE_PATH, "tisgrabber_x64.dll"))
    else:
        __tisgrabber = C.windll.LoadLibrary(os.path.join(FILE_PATH, "tisgrabber.dll"))
